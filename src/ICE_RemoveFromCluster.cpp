...
CStatus Register_MOM_RemoveFromCluster( PluginRegistrar& in_reg )
{
	ICENodeDef nodeDef;
	nodeDef = Application().GetFactory().CreateICENodeDef(L"MOM_RemoveFromCluster",L"MOM_RemoveFromCluster");
...
SICALLBACK MOM_RemoveFromCluster_Evaluate( ICENodeContext& in_ctxt )
{
